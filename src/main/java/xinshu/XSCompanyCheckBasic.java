...
@Component("ex_xinshu_checkBasic")
public class XSCompanyCheckBasic extends BaseJiSuSourceRequestor implements IDataSourceRequestor {
    ...
    public Map<String, Object> request(String trade_id, DataSource ds) throws UnsupportedEncodingException {
        ...
        String reqUrl = propertyEngine.readById("ds_xinshu_checkBasic_url");
        ...
        try{
            ...
            logger.info("{}:请求格式化日期:{}",prefix,currDate);
            ...
            if(code.equals("0000")){ //000000
                ...
                JSONObject respDate = json.getJSONObject("data");
                	...
                	//获取BASIC子节点中的数据
                	 ...
                	 basic.remove("ENTID");
                	 basic.remove("ENTNAMEENG");
                	 basic.remove("ORIREGNO");
                 ...
                 //获取PERSON子节点中的数据(其为一个数组)
                   JSONArray PersonArray = respDate.getJSONArray("PERSON");
