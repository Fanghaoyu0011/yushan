...
@Component("ex_TDFinancial_Inquire")
public class TDFinancialRequest extends BaseDataSourceRequestor implements IDataSourceRequestor {
    private final static Logger logger=LoggerFactory.getLogger(TDFinancialRequest.class) ;
    ...
    public Map<String, Object> request(String trade_id, DataSource ds){
        ...
        String reqUrl = propertyEngine.readById("ds_TDFinancial_reqUrl");
        ...
        try {
            ...
            //获取参数
            String id = ParamUtil.findValue(ds.getParams_in(), "mobile").toString();//手机号
            String type = ParamUtil.findValue(ds.getParams_in(), "type").toString();//pid：手机号 pidmd5:手机号的原值md5加密，加密后32位小写md5
            //封装打印日志入参
            reqsParam.put("id",id);
...
//                    JSONObject proJson = proJson(resJson);
        ...
        logger.info("{}  PID金融特征查询END,耗时：{}", prefix, System.currentTimeMillis() - startTime);
        return rets;
    }
}
