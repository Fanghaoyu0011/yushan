 ...
 * 风险反欺诈
 */
@Component("ex_TDAntifraud_Inquire")
public class TDAntifraudRequest extends BaseDataSourceRequestor implements IDataSourceRequestor {
    private final static Logger logger=LoggerFactory.getLogger(TDAntifraudRequest.class) ;
    ...
    public Map<String, Object> request(String trade_id, DataSource ds){
        ...
        String reqUrl = propertyEngine.readById("ds_TDAntifraud_reqUrl");
        ...
        try {
            ...
            //获取参数
            String id = ParamUtil.findValue(ds.getParams_in(), "deviceNo").toString();//设备id
            String type = ParamUtil.findValue(ds.getParams_in(), "type").toString();//支持imeimd5/idfamd5/oaidmd5/pidmd5
            //封装打印日志入参
            reqsParam.put("id",id);
...
//                    JSONObject proJson = proJson(resJson);
        ...
        logger.info("{}  风险反欺诈查询END,耗时：{}", prefix, System.currentTimeMillis() - startTime);
        return rets;
    }
}
