...
@Component("ex_TDCredit_Inquire")
public class TDCreditRequest extends BaseDataSourceRequestor implements IDataSourceRequestor {
    private final static Logger logger=LoggerFactory.getLogger(TDCreditRequest.class) ;
    ...
    public Map<String, Object> request(String trade_id, DataSource ds){
        ...
        String reqUrl = propertyEngine.readById("ds_TDCredit_reqUrl");
...
//                    JSONObject proJson = proJson(resJson);
        ...
        logger.info("{}  TD信贷授信分查询END,耗时：{}", prefix, System.currentTimeMillis() - startTime);
        return rets;
    }    
}
