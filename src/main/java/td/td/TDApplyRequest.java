...
@Component("ex_TDApply_Inquire")
public class TDApplyRequest extends BaseDataSourceRequestor implements IDataSourceRequestor {
    private final static Logger logger=LoggerFactory.getLogger(TDApplyRequest.class) ;
    ...
    public Map<String, Object> request(String trade_id, DataSource ds){
        ...
        String reqUrl = propertyEngine.readById("ds_TDApply_reqUrl");
        ...
        try {
            ...
            String responseToken = RequestHelper.doGet(tokenUrl, paramsMap, false);
...
//                    JSONObject proJson = proJson(resJson);
        ...
        logger.info("{}  TD申请分查询END,耗时：{}", prefix, System.currentTimeMillis() - startTime);
        return rets;
    }
