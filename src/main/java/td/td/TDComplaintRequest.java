 ...
 * 投诉类
 */
@Component("ex_TDComplaint_Inquire")
public class TDComplaintRequest extends BaseDataSourceRequestor implements IDataSourceRequestor {
    private final static Logger logger=LoggerFactory.getLogger(TDComplaintRequest.class) ;
    ...
    public Map<String, Object> request(String trade_id, DataSource ds){
        ...
        String reqUrl = propertyEngine.readById("ds_TDComplaint_reqUrl");
...
//                    JSONObject proJson = proJson(resJson);
        ...
        logger.info("{}  投诉类信息查询END,耗时：{}", prefix, System.currentTimeMillis() - startTime);
        return rets;
    }
}
